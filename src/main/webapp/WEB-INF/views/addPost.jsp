...
<title>add post</title>
 ...
 <spring:url value="/forum/savePost" var="addURL"/>
        ...
        <div class="container">
          <h1 class="jumbotron-heading">HappyReader</h1>
   		...
   		<div class="container-fluid" >
   			<div class="container" >
   				<div align="center">
			    <h3 style="font-family: sans-serif; color: gray; font-size: 30 em;">Add a Post</h3>
			    <form:form action="${addURL}" method="post" modelAttribute="postForm" enctype="multipart/form-data" class = "form-group" >
